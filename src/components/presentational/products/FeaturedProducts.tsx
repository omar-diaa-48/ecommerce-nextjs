                    ...
                    {products.map((product) => (
                        <div onClick={() => handleNavigate(product.id)} key={product.id} className="relative cursor-pointer">
                            <div className="aspect-square overflow-hidden relative">
                                <Image sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" fill className="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src={product.images[0]} alt="" />
                            </div>
